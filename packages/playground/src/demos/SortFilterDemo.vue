    ...
    <div class="layout">
      <div>
        <div :class="`theme-${activeTheme}`">
          ...
          >
            <!-- Clickable header label with sort indicator -->
      ...
      <aside class="perf-panel">
        ...
        <p v-else class="perf-empty">Sort or filter to see timings.</p>
      </aside>
    </div>
  </div>
</template>
...
.ctrl-input {
  ...
  padding: 0.3rem 0.55rem; font-size: 0.8rem; outline: none; width: 150px;
  transition: border-color 120ms;
}
.ctrl-input:focus { border-color: #0f5bd4; box-shadow: 0 0 0 3px rgba(15,91,212,0.1); }
